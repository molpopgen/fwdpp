...
namespace KTfwd
{
  namespace experimental
  {
    ...
    dispatch_w(rules_t && r,
	       ...
	       gcont_t & gametes,
	       const mcont_t & mutations,
	       const fitness_func_t &)  -> decltype(r.w(diploids,gametes,mutations))
    {
    ...
    dispatch_update(rules_t && r,
		    ...
		    const mcont_t & mutations,
		    const fitness_func_t &) -> decltype(r.update(rng,offspring,parent1,parent2,gametes,mutations))
    {
    ...
    dispatch_update(rules_t && r,
    		    ...
    		    const gcont_t & gametes,
    		    const mcont_t & mutations,
    		    const fitness_func_t & ff) -> decltype(r.update(rng,offspring,parent1,parent2,gametes,mutations,ff))
    {
