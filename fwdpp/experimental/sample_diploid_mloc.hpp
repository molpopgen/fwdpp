/*!
  ...
  \brief Testing ground for more flexible API to evolve populations -- multilocus version.
*/
...
namespace KTfwd
{
  ...
  {
    /*!
      \brief Abstraction of the standard Wright-Fisher sampling process for a multi-locus/region simulation
    */
	...
	for(unsigned i=0;i<N_curr;++i)
	  {
	    ...
	    //No need to dispatch--this type of simulation is always
	...
	*/
    ...
    template< typename diploid_geno_t,
	      ...
	      >
    double sample_diploid(const gsl_rng * r,
    ...
    */
      ...
      for(auto & dip : diploids )
	{
	  ...
	  //Pick parent 2
	  size_t p2 = rules.pick2(r,p1,f,parents[p1],gametes,mutations);
    ...
    */
    {
      return experimental::sample_diploid(r,gametes,diploids,mutations,mcounts,
					  N,N,mu,mmodel,rec_policies,r_between_loci,
					  blrf,ff,neutral,selected,f,rules,mp,gpolicy_mut);
    }
  }
}
