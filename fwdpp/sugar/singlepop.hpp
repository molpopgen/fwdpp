...
namespace KTfwd
{
  ...
  /*!
    Single population without serialization.  Cannot be copied, etc.
    \ingroup sugar
  */
  ...
  /*!
    Single population with serialization.  Can be copied, etc.
    \ingroup sugar
  */
...
namespace KTfwd
{
  ...
  /*!
    \brief Single population without serialization.  Cannot be copied, etc.
    \ingroup sugar
  */
  template<typename mtype> using singlepop = sugar::singlepop<mtype,
							      mlist_t<mtype>,
  ...
  /*! 
    \brief Single population with serialization.  Can be copied, etc.
    \ingroup sugar
  */
  template<typename mtype,
	   typename mwriter_t,
