        ...
        namespace types
        {
            ...
            /// \version 0.8.0 Now holds a list of samples. Samples may be assigned to groups.
            {
              ...
              public:
                ...
                std::vector<id_type> parents, leaf_counts, preserved_leaf_counts,
                    left_sib, right_sib, left_child, right_child, left_sample,
                    right_sample, next_sample, sample_index_map;
                ...
                marginal_tree(std::size_t nnodes, const SAMPLES& samples,
                    ...
                    : num_nodes(nnodes), sample_groups(fill_sample_groups(samples)),
                      ...
                      parents(nnodes, null), leaf_counts(nnodes, 0),
                      preserved_leaf_counts(nnodes, 0), left_sib(nnodes, null),
                      right_sib(nnodes, null), left_child(nnodes, null),
                      right_child(nnodes, null), left_sample(nnodes, null),
                      right_sample(nnodes, null), next_sample(nnodes, null),
                      sample_index_map(nnodes, null), above_sample(nnodes, 0),
