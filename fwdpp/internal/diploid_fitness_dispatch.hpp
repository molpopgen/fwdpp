...
namespace KTfwd {
  namespace fwdpp_internal{
    ...
    double diploid_fitness_dispatch( const fitness_policy_type & fp, const diploid_itr_t & d, std::false_type ) {
    ...
    template<typename fitness_policy_type,
	     typename diploid_itr_t>
    double  diploid_fitness_dispatch( const fitness_policy_type & fp, const diploid_itr_t & d, std::true_type ) { 
      return fp(d);
    }
