...
namespace KTfwd
{
  /*! \brief Sample the next generation of dipliods in an individual-based simulation.  Constant population size case.
    ...
    \param mcounts Vector of integers corresponding to counts of each element in mutations
    ...
    \param mp Policy determining how whether or not to remove fixed variants from the gametes.
  ...
  */
  ...
  /*! \brief Evolve a metapopulation where demes are not changing size.  For individual-based sims.
    ...
    \param diploids Vector of vectors of parents from which we sample offspring
