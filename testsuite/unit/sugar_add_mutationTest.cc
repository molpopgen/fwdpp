...
BOOST_FIXTURE_TEST_SUITE(test_add_mutation_singlepop,singlepop_popgenmut_fixture)
...
BOOST_FIXTURE_TEST_SUITE( test_add_mutation_multiloc, multiloc_popgenmut_fixture )
