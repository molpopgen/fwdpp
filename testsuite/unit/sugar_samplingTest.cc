...
BOOST_FIXTURE_TEST_SUITE( test_singlepop_custom_sampling, singlepop_popgenmut_custom_fixture )
...
BOOST_FIXTURE_TEST_SUITE(test_metapop_custom_sampling, metapop_popgenmut_custom_fixture)
