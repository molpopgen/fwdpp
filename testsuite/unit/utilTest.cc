...
BOOST_FIXTURE_TEST_CASE( only_recycle_extinct_mutations,standard_empty_single_deme_fixture )
{
...
BOOST_FIXTURE_TEST_CASE( test_recycle_all_fixations,standard_empty_single_deme_fixture ) 
{
  KTfwd::uint_t N=1000;
  //This is a neutral mutation
  mutations.emplace_back(0.1,0);
...
BOOST_FIXTURE_TEST_CASE( test_recycle_all_fixations_and_move_to_fixations_vector,standard_empty_single_deme_fixture ) 
{
  KTfwd::uint_t N=1000;
  //This is a neutral mutation
  mutations.emplace_back(0.1,0);
  ...
  mcounts.emplace_back(2*N);
  //use generation = 2
  KTfwd::update_mutations(mutations,fixations,fixation_times,mut_lookup,mcounts,2,2*N);
  BOOST_REQUIRE_EQUAL(mcounts[0],0);
  BOOST_REQUIRE_EQUAL(mutations.size(),1);
...
BOOST_FIXTURE_TEST_CASE( only_recycle_neutral_fixations,standard_empty_single_deme_fixture )
{
  KTfwd::uint_t N=1000;
  //This is a neutral mutation
  mutations.emplace_back(0.1,0);
  ...
  mcounts.emplace_back(2*N);
  //use generation = 2
  KTfwd::update_mutations_n(mutations,fixations,fixation_times,mut_lookup,mcounts,2,2*N);
  BOOST_REQUIRE_EQUAL(mcounts[0],0);
