...
\begin{lstlisting}
  std::bind(KTfwd::genetics101(),  //the rec. model
             std::placeholders::_1,std::placeholders::_2,                  //placeholder for iterators to gametes
...
\begin{lstlisting}
  double wbar = KTfwd::sample_diploid(r,
      					 ...
      					 to be mutated to the mutation model function.  Again, std::placeholders::_1
      					 is used as a placeholder for that gamete.
      				       */
      				       std::bind(mutmodel_Qtrait,r,std::placeholders::_1,mu_neutral,mu_selected,sigma_e,&lookup),
