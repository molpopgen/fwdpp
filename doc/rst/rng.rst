...
The random number generator type is :class:`fwdpp::GSLrng_mt`, which is a mersenne twister.
...
:class:`fwdpp::GSLrng_mt` is defined as a template ``typedef`` of :class:`fwdpp::GSLrng_t`.
